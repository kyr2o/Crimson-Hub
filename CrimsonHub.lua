...
local oldHttpSuccess, oldHttpResult = tryRequest(http\_request)
...
pfp.Image = "[https://www.roblox.com/headshot-thumbnail/image?userId=](https://www.roblox.com/headshot-thumbnail/image?userId=)"..localPlayer.UserId.."&width=420&height=420&format=png"
...
local apiUrl = ("[https://api.github.com/repos/%s/%s/contents/%s?ref=%s](https://api.github.com/repos/%s/%s/contents/%s?ref=%s)"):format(githubUsername, repoName, gameId, branchName)
