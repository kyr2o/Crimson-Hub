...
local function __mm2_pred_from_ping(ms)
    ...
    if ms <= 40  then return 0.125 end
    if ms <= 60  then return 0.13 end
    if ms <= 80  then return 0.135 end
    if ms <= 100 then return 0.14 end
    if ms <= 120 then return 0.145 end
    if ms <= 150 then return 0.15 end
    if ms <= 180 then return 0.155 end
    if ms <= 220 then return 0.16 end
    return 0.21
end
